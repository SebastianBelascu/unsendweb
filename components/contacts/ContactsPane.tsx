...
const SUBSCREENS: { key: Subscreen; label: string; title: string; Icon: typeof MessageCircle }[] =
  [
    { key: "chat", label: "Chat Friends", title: "Contacts", Icon: MessageCircle },
    ...
    <div className="flex h-full flex-col">
      <header className="flex flex-col gap-3 border-b border-line px-4 pb-3 pt-4">
        <div className="flex items-center gap-2">
          <h1 className="text-title font-bold text-ink-strong">{active.title}</h1>
